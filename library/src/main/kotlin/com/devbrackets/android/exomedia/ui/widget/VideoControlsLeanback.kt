...
class VideoControlsLeanback : DefaultVideoControls {
  ...
  override fun animateVisibility(toVisible: Boolean) {
    ...
    if (!isLoading) {
      controlsParent.startAnimation(BottomViewHideShowAnimation(controlsParent, toVisible, DefaultVideoControls.CONTROL_VISIBILITY_ANIMATION_LENGTH))
    }
  ...
  override fun updateTextContainerVisibility() {
    ...
    if (hideEmptyTextContainer && emptyText && textContainer.visibility == View.VISIBLE) {
      ...
      textContainer.startAnimation(BottomViewHideShowAnimation(textContainer, false, DefaultVideoControls.CONTROL_VISIBILITY_ANIMATION_LENGTH))
    } else if ((!hideEmptyTextContainer || !emptyText) && textContainer.visibility != View.VISIBLE) {
      textContainer.clearAnimation()
      textContainer.startAnimation(BottomViewHideShowAnimation(textContainer, true, DefaultVideoControls.CONTROL_VISIBILITY_ANIMATION_LENGTH))
    }
  }
  ...
  protected inner class LeanbackInternalListener : DefaultVideoControls.InternalListener() {
