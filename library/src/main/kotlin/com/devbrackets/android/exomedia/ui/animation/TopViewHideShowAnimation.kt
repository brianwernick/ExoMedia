...
/**
 * An animation used to slide [com.devbrackets.android.exomedia.ui.widget.VideoControls]
 * in and out from the top of the screen when changing visibilities.
 */
class TopViewHideShowAnimation(private val animationView: View, private val toVisible: Boolean, duration: Long) : AnimationSet(false) {
    ...
    init {
        ...
        val startY = if (toVisible) -animationView.height else 0
        val endY = if (toVisible) 0 else -animationView.height
    ...
    private inner class Listener : Animation.AnimationListener {
