...
class VideoViewAttributeParser {
    ...
    fun parse(context: Context, attrs: AttributeSet?): VideoViewAttributes {
        ...
        val useDefaultControls =
            typedArray.getBoolean(R.styleable.VideoView_useDefaultControls, false)
        val useTextureViewBacking =
            typedArray.getBoolean(R.styleable.VideoView_useTextureViewBacking, false)
