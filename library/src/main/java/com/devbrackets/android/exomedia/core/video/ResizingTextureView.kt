 ...
 */
open class ResizingTextureView : TextureView, ClearableSurface {
    ...
    protected val attachedListener: View.OnAttachStateChangeListener = AttachedListener()
    ...
    protected var measureBasedOnAspectRatio: Boolean = false
    ...
    override fun clearSurface() {
        ...
        try {
            ...
            val eglSurface = gl10.eglCreateWindowSurface(display, configs[0], surfaceTexture, intArrayOf(EGL10.EGL_NONE))
     ...
     */
    protected fun updateVideoSize(width: Int, height: Int): Boolean {
     ...
     */
    private inner class AttachedListener : View.OnAttachStateChangeListener {
    ...
    companion object {
        private val TAG = "ResizingTextureView"
         ...
         */
        private val GL_CLEAR_CONFIG_ATTRIBUTES = intArrayOf(EGL10.EGL_RED_SIZE, 8, EGL10.EGL_GREEN_SIZE, 8, EGL10.EGL_BLUE_SIZE, 8, EGL10.EGL_ALPHA_SIZE, 8, EGL10.EGL_RENDERABLE_TYPE, EGL10.EGL_WINDOW_BIT, EGL10.EGL_NONE, 0, EGL10.EGL_NONE)
