...
open class MediaSourceProvider {
    ...
    private fun findByProviders(uri: Uri): SourceTypeBuilder? {
    ...
    private fun findByLooseComparison(uri: Uri): SourceTypeBuilder? {
        val uriString = uri.toString()
        return builders().firstOrNull {
            it.looseComparisonRegex?.toRegex()?.matches(uriString) == true
        }
    }
}
