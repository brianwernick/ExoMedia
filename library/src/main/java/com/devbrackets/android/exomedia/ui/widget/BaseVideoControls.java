...
public abstract class BaseVideoControls extends RelativeLayout implements VideoControls<BaseVideoControls> {
    ...
    public BaseVideoControls(Context context) {
        super(context);
        setup(context);
    }

    public BaseVideoControls(Context context, AttributeSet attrs) {
        super(context, attrs);
        setup(context);
    }

    public BaseVideoControls(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        setup(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public BaseVideoControls(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    @Override
    public BaseVideoControls getView() {
        return this;
    }
