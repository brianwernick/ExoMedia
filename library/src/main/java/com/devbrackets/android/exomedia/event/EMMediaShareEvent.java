...
/**
 * Used to capture when the Share button is clicked.  This
 ...
 * Instead the standard listeners should be used.  Additionally since this is no
 * longer used, it will be completely removed
 */
@Deprecated
