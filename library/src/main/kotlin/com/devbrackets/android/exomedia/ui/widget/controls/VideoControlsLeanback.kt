...
open class VideoControlsLeanback : DefaultVideoControls {
    ...
    override fun updateButtonDrawables(tintList: Int) {
        ...
        val fastForwardDrawable =
            context.tintListCompat(R.drawable.exomedia_ic_fast_forward_white, tintList)
     ...
     * focused view.
     */
    protected inner class RippleTranslateAnimation(protected var xDelta: Int) :
    ...
    companion object {
        protected const val FAST_FORWARD_REWIND_AMOUNT = 10_000 //10 seconds
    }
}
