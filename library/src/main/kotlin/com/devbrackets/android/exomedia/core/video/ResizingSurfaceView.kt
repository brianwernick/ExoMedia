 ...
 */
open class ResizingSurfaceView : SurfaceView, ClearableSurface {
    ...
    protected var attachedListener: View.OnAttachStateChangeListener = AttachedListener()
    ...
    protected var measureBasedOnAspectRatio = true

    /**
     * Retrieves the current [ScaleType] being used
     *
     * @return The current [ScaleType] being used
     */
    /**
