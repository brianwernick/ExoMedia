...
open class ResizingSurfaceView : SurfaceView, VideoSurface {
    ...
    private var attachedListener: OnAttachStateChangeListener = AttachedListener()
    ...
    private var measureBasedOnAspectRatio = false
    ...
    override fun clearSurface() {
        try {
            ...
            val eglSurface =
                gl10.eglCreateWindowSurface(display, configs[0], this, intArrayOf(EGL10.EGL_NONE))
    ...
    companion object {
        private const val TAG = "ResizingSurfaceView"
