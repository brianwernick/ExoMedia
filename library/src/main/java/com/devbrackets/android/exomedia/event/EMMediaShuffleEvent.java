...
/**
 * Used to capture when the Shuffle button is clicked.  This
 ...
 * Instead the standard listeners should be used.  Additionally since this is
 * no longer used, it will be removed completely
 */
@Deprecated
public class EMMediaShuffleEvent {
